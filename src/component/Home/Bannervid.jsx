...
<span className='border rounded-md border-black bg-black text-white p-3 absolute left-10 top-[235px] cursor-pointer '> Our New Product</span>
      ...
      <div className='absolute left-6  text-2xl   cursor-pointer top-[360px] rounded-md p-2 transition-all delay-100 '><h2 className='text-2xl'>Nike Air Max DN8 </h2>
...
<button className="relative px-3 ml-12 top-[10vh] right-[24vw] py-3 text-black bg-white border-2 border-black rounded-xl overflow-hidden transition-all duration-500 ease-in-out group">
      <span  onClick={()=>{
        navigate('/details/men-002')
      }} className="right-0 relative  z-10 transition-colors duration-500 group-hover:text-white font-normal">
        Buy Now
      </span>
